...
DROP TABLE species CASCADE CONSTRAINT PURGE;
DROP TABLE animal CASCADE CONSTRAINT PURGE;
DROP TABLE centre CASCADE CONSTRAINT PURGE;
DROP TABLE breeding_event CASCADE CONSTRAINT PURGE;
...
COMMENT ON COLUMN centre.centre_address IS
	'The name of the centre address';
...
ADD
		(CONSTRAINT fk_brevent_animal_mother_id FOREIGN KEY (mother_id)
		REFERENCES animal (animal_id),

		CONSTRAINT fk_brevent_father_id FOREIGN KEY(father_id)
		REFERENCES animal (animal_id)
		);
ALTER TABLE animal
	ADD
		(CONSTRAINT fk_animal_centre FOREIGN KEY (centre_id)
		REFERENCES centre(centre_id),

		CONSTRAINT fk_animal_species_spec_genus FOREIGN KEY (spec_genus,spec_name)
		REFERENCES species (spec_genus, spec_name),


		CONSTRAINT fk_animal_brevent_brevent_id FOREIGN KEY (brevent_id)
